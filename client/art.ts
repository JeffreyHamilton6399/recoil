...
export function makeWeaponIcon(index: number, w: number, h: number): HTMLCanvasElement {
  ...
  const parts: Record<number, { body: Shape[]; accent: Shape[] }> = {
    ...
    5: {
      body: [[10, 14, 44, 20, 5], [50, 14, 42, 5, 2], [50, 21, 42, 5, 2], [50, 28, 42, 5, 2], [18, 32, 12, 13, 4], [36, 33, 14, 10, 2]],
      accent: [[64, 12, 5, 24, 2], [80, 12, 5, 24, 2]],
    },
    6: {
      body: [[8, 18, 44, 14, 5], [48, 15, 46, 5, 2], [48, 29, 46, 5, 2], [14, 30, 12, 14, 4]],
      accent: [[50, 22, 40, 4, 2], [30, 13, 12, 5, 2]],
    },
    7: {
      body: [[12, 16, 44, 16, 5], [52, 13, 32, 22, 8], [22, 30, 12, 14, 4], [38, 30, 14, 12, 6]],
      accent: [[60, 11, 4, 26, 2], [70, 11, 4, 26, 2], [80, 13, 4, 22, 2]],
    },
  };
